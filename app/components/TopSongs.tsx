            ...
            <li key={index} className="bg-gray-800 rounded-lg overflow-hidden shadow-lg animate-pulse">
              <div className="flex items-center p-4">
                ...
                <div className="grow">
                  ...
                  <div className="h-4 bg-gray-600 rounded-sm w-2/3"></div>
                </div>
                <div className="shrink-0 ml-4 text-right">
                  <div className="h-5 bg-gray-700 rounded-sm w-20 mb-2"></div>
                  <div className="h-4 bg-gray-600 rounded-sm w-10"></div>
                </div>
              </div>
            </li>
          ))}
